/*! Terraformer JS - 1.0.1 - 2013-11-12
...
!function (a, b) {
    ...
    function c(a) {
        if (a.type) switch (a.type) {
            ...
            case"Feature":
                return a.geometry ? c(a.geometry) : null;
    ...
    function p(a, b, c) {
        if ("Point" === a.type) a.coordinates = b(a.coordinates); else if ("Feature" === a.type) a.geometry = p(a.geometry, b, !0); else if ("FeatureCollection" === a.type) for (var d = 0; d < a.features.length; d++) a.features[d] = p(a.features[d], b, !0); else if ("GeometryCollection" === a.type) for (var e = 0; e < a.geometries.length; e++) a.geometries[e] = p(a.geometries[e], b, !0); else a.coordinates = m(a.coordinates, b);
    ...
    function z(a, b) {
        if (a && a.length) {
            ...
            if (y(a[0], b)) {
                for (var c = 1; c < a.length; c++) if (y(a[c], b)) return !1;
                return !0
            }
            return !1
        }
    ...
    function B(a, b) {
        for (var c = 0; c < a.length - 1; c++) for (var d = 0; d < b.length - 1; d++) if (A(a[c], a[c + 1], b[d], b[d + 1])) return !0;
        return !1
    }

    function C(a, b) {
        for (var c = 0; c < b.length; c++) for (var d = b[c], e = 0; e < d.length - 1; e++) for (var f = 0; f < a.length - 1; f++) if (A(d[e], d[e + 1], a[f], a[f + 1])) return !0;
        return !1
    }

    function D(a, b) {
        for (var c = 0; c < a.length; c++) if (C(a[c], b)) return !0;
        return !1
    }
    ...
    function I(a, b) {
        for (var c = 0; c < a.length; c++) for (var d = 0; d < b.length; d++) if (a[c] !== b[d]) return !1;
        return !0
    }
    ...
    function L(a) {
        ...
        if (a && "Point" === a.type && a.coordinates) b(this, a); else if (a && isArray(a)) this.coordinates = a; else {
    ...
    function M(a) {
        if (a && "MultiPoint" === a.type && a.coordinates) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.MultiPoint";
            this.coordinates = a
        }
    ...
    function N(a) {
        if (a && "LineString" === a.type && a.coordinates) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.LineString";
            this.coordinates = a
        }
    ...
    function O(a) {
        if (a && "MultiLineString" === a.type && a.coordinates) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.MultiLineString";
            this.coordinates = a
        }
    ...
    function P(a) {
        if (a && "Polygon" === a.type && a.coordinates) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.Polygon";
            this.coordinates = a
        }
        this.type = "Polygon"
    }
    ...
    function Q(a) {
        if (a && "MultiPolygon" === a.type && a.coordinates) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.MultiPolygon";
            this.coordinates = a
        }
    ...
    function R(a) {
        if (a && "Feature" === a.type) b(this, a); else {
    ...
    function S(a) {
        if (a && "FeatureCollection" === a.type && a.features) b(this, a); else {
            if (!isArray(a)) throw"Terraformer: invalid input for Terraformer.FeatureCollection";
            this.features = a
        }
    ...
    function T(a) {
        if (a && "GeometryCollection" === a.type && a.geometries) b(this, a); else if (isArray(a)) this.geometries = a; else {
    ...
    function U(a, b, c) {
        for (var d = o(a), e = c || 64, f = {type: "Polygon", coordinates: [[]]}, g = 1; e >= g; g++) {
    ...
    function V(a, c, d) {
        ...
        b(this, new R({type: "Feature", geometry: U(a, f, e), properties: {radius: f, center: a, steps: e}}))
    }

    var W = {}, X = 6378137, Y = 57.29577951308232, Z = .017453292519943,
        $ = {type: "link", properties: {href: "http://spatialreference.org/ref/sr-org/6928/ogcwkt/", type: "ogcwkt"}},
        _ = {type: "link", properties: {href: "http://spatialreference.org/ref/epsg/4326/ogcwkt/", type: "ogcwkt"}};
    isArray = function (a) {
    ...
    return K.prototype.toMercator = function () {
        ...
        if ("Polygon" === a.type) {
            if ("Polygon" === this.type) {
                if (a.coordinates.length === this.coordinates.length) for (c = 0; c < this.coordinates.length; c++) if (J(this.coordinates[c], a.coordinates[c])) return !0;
            ...
            if ("LineString" === this.type || "MultiPoint" === this.type) {
                ...
                for (c = 0; c < this.coordinates.length; c++) if (z(a.coordinates, this.coordinates[c]) === !1) return !1;
                return !0
            }
            ...
            if ("MultiPolygon" === this.type) {
                for (c = 0; c < this.coordinates.length; c++) {
                    var g = new K({type: "Polygon", coordinates: this.coordinates[c]});
        ...
        if ("MultiPolygon" === a.type) {
            if ("Point" === this.type) {
                if (a.coordinates.length) for (c = 0; c < a.coordinates.length; c++) if (b = a.coordinates[c], z(b, this.coordinates) && D(this.coordinates, a.coordinates) === !1) return !0;
                return !1
            }
            if ("Polygon" === this.type) {
                for (c = 0; c < this.coordinates.length; c++) if (a.coordinates[c].length === this.coordinates.length) for (j = 0; j < this.coordinates.length; j++) if (J(this.coordinates[j], a.coordinates[c][j])) return !0;
